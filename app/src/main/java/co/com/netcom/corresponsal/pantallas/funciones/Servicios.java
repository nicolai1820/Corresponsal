...
public class Servicios {
    ...
    public Map<String,String> generarVenta(InfoVenta objetoVenta){
        ...
        OkHttpClient client = builder.sslSocketFactory(getSLLContext().getSocketFactory())
