...
public class TLV {
    ...
    public String getTag() {
        ...
        return this.tag = BytesUtil2.bytes2HexString(BytesUtil.subBytes(this.data, 0, tLen));
    }
    ...
    public String getValue() {
        ...
        return BytesUtil2.bytes2HexString(result);
    }
    ...
    public byte[] getBytesValue() {
        ...
        int l = getLength();
        return this.value = BytesUtil2.subBytes(this.data, this.data.length - l, l);
    }
    ...
    private static byte[] makeLengthData(int len) {
        if (len > 127) {
            ...
            lenData = BytesUtil2.subBytes(lenData, validIndex, -1);
            lenData = BytesUtil2.merge(new byte[][]{{(byte) (0x80 | lenData.length)}, lenData});
            return lenData;
        }
    ...
    public String toString() {
        ...
        return BytesUtil2.bytes2HexString(this.data);
    }
}
