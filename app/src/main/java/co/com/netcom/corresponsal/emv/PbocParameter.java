...
class PbocParameter implements Serializable, EmvParameter {
    ...
    public String pack() throws EmvParameterException {
        ...
        tlvList.addTLV(EmvTags.C_TAG_TM_9F7B, BytesUtil2.toBCDAmountBytes(this.ecLimit));
        ...
        tlvList.addTLV(EmvTags.C_TAG_TM_TRANS_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfTransactionLimit));


        if (this.rfCvmLimit == null || this.rfCvmLimit < 0) {
            throw new EmvParameterException("Amount should be an integer greater than or equal to 0.");
        }
        tlvList.addTLV(EmvTags.C_TAG_TM_CVM_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfCvmLimit));

        if (this.rfFloorLimit == null || this.rfFloorLimit < 0) {
            throw new EmvParameterException("Amount should be an integer greater than or equal to 0.");
        }
        tlvList.addTLV(EmvTags.C_TAG_TM_FLOOR_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfFloorLimit));
