...
public class Const {
	...
	public static final int DATOS_ADICIONALES_FINISH = 1;
	public static final int PIN_EVENT_INPUT_CONFIRM = 10;
	public static final int TRANSACCION_CANCELADA = 20;
    /**
     * 打印
     */
	...
	public   static  final  int PUNTOS_COLOMBIA_GALONES =1;
	public   static  final  int CONFIGURACION_PUNTOS =2;
	public   static  final  int BORRAR_REVERSO =3;
	public   static  final  int CONFIRMAR_BORRAR_REVERSO =4;
	public   static  final  int REVERSO_NO_EXISTE =5;

	//MENU VER//
	public   static  final  int VER_REVERSO =6;
	public   static  final  int ENVIAR_REVERSO =7;
