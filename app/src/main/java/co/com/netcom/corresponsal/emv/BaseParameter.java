...
class BaseParameter implements Serializable, EmvParameter {
    BaseParameter() {
        ...
        this.countryCode = new byte[]{0x01, 0x70};
        this.currencyCode = new byte[]{0x01, 0x70};
    ...
    public String pack() throws EmvParameterException {
        ...
        if (this.floorLimit != null) {
            ...
            tlvList.addTLV(EmvTags.EMV_TAG_TM_FLOORLMT, BytesUtil2.toFourByteArray(this.floorLimit));
        }
        ...
        tlvList.addTLV(EmvTags.DEF_TAG_RAND_SLT_THRESHOLD, BytesUtil2.toBCDAmountBytes(this.randomSelectionThreshold));
        ...
        if (this.otherParameters != null) {
            byte[] tempBuf = BytesUtil2.merge(tlvList.toBinary(), this.otherParameters.toBinary());
            return BytesUtil2.bytes2HexString(tempBuf);
        }
