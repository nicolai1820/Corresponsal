...
class MasterParameter implements Serializable, EmvParameter {
    ...
    public String pack() throws EmvParameterException {
        ...
        tlvList.addTLV(EmvTags.M_TAG_TM_TRANS_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfTransactionLimit));

        if (this.rfTransactionLimitCdv == null || this.rfTransactionLimitCdv < 0) {
            throw new EmvParameterException("Amount should be a long integer greater than or equal to 0.");
        }
        tlvList.addTLV(EmvTags.M_TAG_TM_TRANS_LIMIT_CDV, BytesUtil2.toBCDAmountBytes(this.rfTransactionLimitCdv));

        if (this.rfCvmLimit == null || this.rfCvmLimit < 0) {
            throw new EmvParameterException("Amount should be a long integer greater than or equal to 0.");
        }
        tlvList.addTLV(EmvTags.M_TAG_TM_CVM_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfCvmLimit));

        if (this.rfFloorLimit == null || this.rfFloorLimit < 0) {
            throw new EmvParameterException("Amount should be a long integer greater than or equal to 0.");
        }
        tlvList.addTLV(EmvTags.M_TAG_TM_FLOOR_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfFloorLimit));
