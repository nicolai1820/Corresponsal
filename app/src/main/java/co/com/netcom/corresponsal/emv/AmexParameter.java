...
class AmexParameter implements Serializable, EmvParameter {
    ...
    public String pack() throws EmvParameterException {
        ...
        if (this.rfTransactionLimit != null) {
            ...
            tlvList.addTLV(EmvTags.A_TAG_TM_TRANS_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfTransactionLimit));
        }
        ...
        if (this.rfCvmLimit != null) {
            ...
            tlvList.addTLV(EmvTags.A_TAG_TM_CVM_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfCvmLimit));
        }
        ...
        if (this.rfFloorLimit != null) {
            ...
            tlvList.addTLV(EmvTags.A_TAG_TM_FLOOR_LIMIT, BytesUtil2.toBCDAmountBytes(this.rfFloorLimit));
        }
